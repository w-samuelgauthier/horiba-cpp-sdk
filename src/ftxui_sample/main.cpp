...
// configuration step. It creates a namespace called `horiba_cpp_sdk`. You can modify
...
{
  try {
    CLI::App app{ fmt::format("{} version {}", horiba_cpp_sdk::cmake::project_name, horiba_cpp_sdk::cmake::project_version) };
    ...
    if (show_version) {
      fmt::print("{}\n", horiba_cpp_sdk::cmake::project_version);
      return EXIT_SUCCESS;
    }
